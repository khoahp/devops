...
/**
 * Provides the local service interface for SimpleFrom. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SimpleFromLocalServiceUtil
...
public interface SimpleFromLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SimpleFromLocalServiceUtil} to access the simple from local service. Add custom service methods to {@link com.fds.devops.simpleform.service.impl.SimpleFromLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SimpleFrom fetchSimpleFromByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SimpleFrom getSimpleFromByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SimpleFrom> getSimpleFromsByUuidAndCompanyId(
